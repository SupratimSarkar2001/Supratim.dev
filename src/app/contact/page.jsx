      ...
      <div className={styles.textContainer}>
        ...
        <div className={styles.connectLinks}>
          ...
          href={"https://github.com/SupratimSarkar2001"} target='_blank'>
            <Image src="/github.png" alt="githbub" className={styles.img_logo} width={40} height={40} />
          </Link>
          <Link
          className={styles.link}
           href={"https://www.linkedin.com/in/supratimsarkar08/"} target='_blank'>
            <Image src="/linkedin.png" alt="linkedin" className={styles.img_logo} width={40} height={40} />
          </Link>
          <Link 
          className={styles.link}
          href={"https://twitter.com/8ssarkar"} target='_blank'>
            <Image src="/x.png" alt="x" className={styles.img_logo} width={40} height={40} />
          </Link>
        </div>
